...
struct Router {
    let baseURL = "https://api-sandbox.mysitoo.com/v2/accounts/90316"

    var productList: String {
        baseURL + "\(Route.productList.rawValue)"
    }

    var productDetails: String {
        baseURL + "\(Route.productDetails.rawValue)"
    }

    private enum Route: String {
        case productList = "/sites/1/products.json?start={startIndex}&num={itemsCount}&fields=title,moneyprice"
